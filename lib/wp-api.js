...
import { getBridgePosts, getBridgeGallery, propertyCode, mapWordPressPost, mergeCatalog, mergePhotoGallery } from "@/lib/wordpress-bridge.mjs";
...
export async function getPropertyById(id) {
    ...
    const isBridgeCode = ["A1149", "A1163", "A1164", "A1165"].includes(code);
    ...
    if (base) {
        return code === "A1149" && post ? mergePhotoGallery(base, await getBridgeGallery(post)) : base;
    }
